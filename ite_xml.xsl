...
<?xml-stylesheet type="text/xsl" href="ite_xml.xsl"?>
<ite2 nombre="Instituto Tecnologico Edix" web="https://institutotecnologico.edix.com" >
    ...
    <ciclos>
        <ciclo id="ASIR">
            ...
            <decretoTitulo anno="2009" />
        </ciclo>
        <ciclo id="DAW">
            <nombre>Desarrollo de Aplicaciones Web</nombre>
            <grado>Superior</grado>
            <decretoTitulo anno="2010" />
        </ciclo>
        <ciclo id="DAM">
